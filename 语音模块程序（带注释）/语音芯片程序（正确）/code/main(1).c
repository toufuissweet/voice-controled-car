...
void 	User_handle(uint8 dat)
{
     //UARTSendByte(dat);//串口识别码（十六进制）
			 ...
			 switch(dat)		   /*对结果执行相关操作,客户修改*/
			  {
				  case CODE_DMCS:	  /*命令“加速”*/	
				
						UARTSendByte(0xbf);							 break;
					case CODE_KFBYZ:	 /*命令“减速”*/
				
						UARTSendByte(0xdf);						 break;
					case CODE_KD:		/*命令“前进”*/				
				
						UARTSendByte(0xfe);				break;
					case CODE_GD:		/*命令“后退”*/				
				
						UARTSendByte(0xfd);							break;
					case CODE_BJ:		/*命令“左转”*/				
				
						UARTSendByte(0xfb);						break;
					case CODE_SH:		/*命令“右转”*/				
				
							UARTSendByte(0xf7);						break;
					case CODE_GZ:		/*命令“停止”*/				
				
						   UARTSendByte(0xef);					break;																											
